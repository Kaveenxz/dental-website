    ...
    <>
      <nav
        className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ease-out
          /* Always visible background — works on both white and dark pages */
          bg-white/70 backdrop-blur-2xl
          ${scrolled
            ? "shadow-[0_4px_30px_rgba(0,0,0,0.06)] border-b border-black/5"
            : "shadow-none border-b border-black/[0.03]"
          }
        `}
      >
      ...
      >
        ...
        <div
          className={`absolute top-[72px] left-0 right-0 bg-white/95 backdrop-blur-2xl border-b border-black/5 shadow-2xl transition-all duration-500 origin-top ${
            mobileOpen
